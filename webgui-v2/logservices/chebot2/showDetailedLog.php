...
//Get Data
$glREPO = new GameLogRepo('vindinium2');
$gsREPO = new GameStepRepo('vindinium2');
				...
				<div class="modal-body">
					<div class="table-responsive">
                        <table class="table table-bordered">
							...
							$deltaOwnLife = $gs->getLifeDiff();
							$deltaOwnMines = $gs->getMineDiff();
							$deltaOwnLifeResult = $deltaOwnLife - 20;
							$deltaOwnMinesResult = $deltaOwnMines * 70;
							
                            echo "<tr>
							<td>For $action and deltaOwnLife = $deltaOwnLife.</td>
                            <td>$deltaOwnLifeResult</td>
                            <td>$place$ownLife$ownMines$topEnemyID$topEnemyLife$topEnemyMines$topEnemyDistance$closestEnemyID$closestEnemyLife$closestEnemyMines$closestEnemyDistance</td>
                            <td>Own Life Delta</td>
                            </tr>";

							echo "<tr>
							<td>For $action and deltaOwnMines = $deltaOwnMines.</td>
                            <td>$deltaOwnMinesResult</td>
                            <td>$place$ownLife$ownMines$topEnemyID$topEnemyLife$topEnemyMines$topEnemyDistance$closestEnemyID$closestEnemyLife$closestEnemyMines$closestEnemyDistance</td>
                            <td>Own Mines Delta</td>
                            </tr>";
